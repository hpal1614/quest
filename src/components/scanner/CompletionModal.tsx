        ...
        <>
          ...
          >
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className={`bg-gradient-to-r ${questTheme.gradient} p-6 relative overflow-hidden`}>
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                ...
                >
                  ...
                  <h2 className="text-3xl font-bold mb-2 text-gray-900">Congratulations!</h2>
                  <p className="text-lg text-gray-800">Quest Complete!</p>
                </motion.div>
              </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    className={`bg-gradient-to-r ${questTheme.gradient} text-gray-900 font-bold py-3 px-4 rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2`}
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
